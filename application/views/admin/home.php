...
<div class="container-fluid">
                ...
                <div class="card">
                    <div class="d-flex flex-row">
                        ...
                        <div class="align-self-center m-l-20">
                            ...
                            <h5 class="text-muted m-b-0">Usuarios inactivos</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Vistas totales</h4>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Estadísticas del navegador</h4>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Los ingresos totales</h4>
                    <div class="clear"></div>
        ...
        <div class="col-lg-4">
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-row">
                                <div class="align-self-center">
                                    ...
                                    <h6 class="text-muted">10% Aumentado</h6>
                                    <h5>(150-165 Sales)</h5>
                                </div>
                                <div class="ml-auto">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Diferencia de ventas</h4>
                            <div class="d-flex flex-row">
                                <div class="align-self-center">
                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-danger delete-event waves-effect waves-light" data-dismiss="modal">Borar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade none-border" id="add-new-event">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title"><strong>Agregar</strong> una categoría</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                </div>
                                <div class="modal-body">
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="control-label">Elegir color de categoría</label>
